...
<template>
  <view class="container">
    <view class="title-bar">
      ...
      <text class="list-title">已发起的活动</text>
    </view>
  </view>

  <view
    class="blank-page"
    v-if="listStore.createdActivityList.length === 0 && pageNum === 0"
  >
    <image class="blank-icon" src="../../assets/images/blank-icon.png" />
    <text class="blank-text">您尚未发起活动哦~</text>
  </view>

  <ActivityCard
    v-for="activity in listStore.createdActivityList"
    :key="activity.
// @ts-ignore
actId"
...
export default {
  ...
  onReachBottom() {
    ...
    that.listStore.getActivityList(2, pageNum);
